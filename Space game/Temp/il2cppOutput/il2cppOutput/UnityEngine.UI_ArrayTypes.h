...
public:
	inline Slider_t297367283 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Slider_t297367283 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
